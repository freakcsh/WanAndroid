package com.example.a74099.wanandroid.model.myself.lock.custom.util;
...
public class SharedPreferencesUtil {
    ...
    public SharedPreferencesUtil() {
        this.prefer = PreferenceManager.getDefaultSharedPreferences(App.getInstance().getApplicationContext());
