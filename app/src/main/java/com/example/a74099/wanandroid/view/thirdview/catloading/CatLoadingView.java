package com.example.a74099.wanandroid.view.thirdview.catloading;
...
import com.example.a74099.wanandroid.util.EyelidView;
...
public class CatLoadingView extends DialogFragment {
	...
	public static CatLoadingView createInstance() {
		...
		catLoadingView.dismissDelayTime = 500;
		catLoadingView.timeOutTime = 8000;
	 ...
	 * 消失延迟时间 ms
	 */
	public long dismissDelayTime = 500;
	/**
	 * 最长等待时间
	 */
